...
public class Exercise4Test extends CompanyDomainForKata
{
    ...
    {
        MutableList<String> supplierNames = this.company.getSuppliers().collect(Supplier.TO_NAME);
    ...
    public void whoSuppliesSandwichToaster()
    {
        ...
        Predicate<Supplier> suppliesToaster = s -> ArrayIterate.anySatisfy(s.getItemNames(), Predicates.equal("sandwich toaster"));
