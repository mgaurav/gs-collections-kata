...
public class Exercise2Test extends CompanyDomainForKata
{
     ...
     */
    private static final Predicate<Customer> CUSTOMER_FROM_LONDON = Predicates.
    ...
    {
        MutableList<Customer> customersNotFromLondon = this.company.getCustomers().select(Predicates.not(CUSTOMER_FROM_LONDON));
